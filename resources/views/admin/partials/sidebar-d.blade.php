...
>
  ...
  >
    <a href="{{ route('dashboard') }}">
      ...
      <img class="logo-icon" :class="sidebarToggle ? 'lg:block' : 'hidden'" src="{{ asset('assets/admin/images/logo/logo-icon.svg') }}" alt="Logo" />
    </a>
  </div>
    ...
    <nav x-data="{selected: $persist('Dashboard')}">
          ...
          <li>
            ...
            <div class="overflow-hidden transform translate" :class="(selected === 'E-Commerce') ? 'block' :'hidden'">
              <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'" class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                <li><a href="{{ route('admin.products.index') }}" class="menu-dropdown-item group" :class="page === 'products' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"> Products </a></li>
                <li><a href="{{ route('admin.categories.index') }}" class="menu-dropdown-item group" :class="page === 'categories' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"> Categories </a></li>
              </ul>
            </div>
          </li>
        </ul>
      ...
      <div>
        ...
        <ul class="flex flex-col gap-4 mb-6">
          <!-- Users -->
          <li>
            <a href="{{ route('admin.users.index') }}" class="menu-item group" :class="(selected === 'Users') || (page === 'users') ? 'menu-item-active' : 'menu-item-inactive'">

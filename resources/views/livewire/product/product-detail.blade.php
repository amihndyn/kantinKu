                    ...
                    <div class="bg-gray-50/50 rounded-xl p-6 border border-gray-200/50 w-full">
                        ...
                        <div class="flex justify-between items-center w-full flex-wrap gap-2">
                            ...
                            <button 
                                ...
                                class="flex items-center space-x-1 text-gray-600 hover:text-red-500 transition duration-200 flex-shrink-0">
                            ...
                            <!-- Bookmark -->
                            <button 
                                class="flex items-center space-x-1 text-gray-600 hover:text-blue-500 transition duration-200 flex-shrink-0">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">

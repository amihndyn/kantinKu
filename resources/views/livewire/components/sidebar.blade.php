<div :class="{ 'dark bg-gray-800 text-white': darkMode }" x-data="{ sidebarToggle, selected: 'Dashboard', page: 'dashboard' }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode')); $watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))">
    <aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'" class="sidebar fixed left-0 top-0 z-9999 flex h-screen w-[290px] flex-col overflow-y-hidden px-5 lg:static lg:translate-x-0 border-r border-gray-200 dark:border-gray-800">
        <!-- SIDEBAR HEADER -->
        ...
        <div class="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
            ...
            <div>
                ...
                <!-- Menu Item Dashboard -->
                <li>
                    <a href="{{ route('dashboard') }}" class="menu-item group" :class=" (selected === 'Dashboard') || (page === 'dashboard') ? 'menu-item-active' : 'menu-item-inactive'">
                ...
                <li>
                    <a href="#" class="menu-item group" @click.prevent="selected = (selected === 'E-Commerce' ? '':'E-Commerce')" :class=" (selected === 'E-Commerce') || (page === 'products' || page === 'categories') ? 'menu-item-active' : 'menu-item-inactive'">
                    <svg :class="(selected === 'E-Commerce') || (page === 'products' || page === 'categories') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''"> E-Commerce </span>
                    <svg class="menu-item-arrow" :class="[(selected === 'E-Commerce') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Dropdown Menu Start -->
                    <div class="overflow-hidden transform translate" :class="(selected === 'E-Commerce') ? 'block' :'hidden'">
                    <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'" class="flex flex-col gap-1 mt-2 menu-dropdown pl-9">
                        <li>
                            <a href="{{ route('admin-products') }}" class="menu-dropdown-item group" :class="page === 'products' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"> Products </a>
                        </li>
                        <li>
                            <a href="categories.html" class="menu-dropdown-item group" :class="page === 'categories' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"> Categories </a>
                        </li>
                    </ul>
                    </div>
                    <!-- Dropdown Menu End -->
            ...
            <div>
                <h3 class="mb-4 text-xs uppercase leading-[20px] text-gray-400">
                <span class="menu-group-title" :class="sidebarToggle ? 'lg:hidden' : ''"> ACCOUNTS </span>
                <svg :class="sidebarToggle ? 'lg:block hidden' : 'hidden'" class="mx-auto fill-current menu-group-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M5.99915 10.2451C6.96564 10.2451 7.74915 11.0286 7.74915 11.9951V12.0051C7.74915 12.9716 6.96564 13.7551 5.99915 13.7551C5.03265 13.7551 4.24915 12.9716 4.24915 12.0051V11.9951C4.24915 11.0286 5.03265 10.2451 5.99915 10.2451ZM17.9991 10.2451C18.9656 10.2451 19.7491 11.0286 19.7491 11.9951V12.0051C19.7491 12.9716 18.9656 13.7551 17.9991 13.7551C17.0326 13.7551 16.2491 12.9716 16.2491 12.0051V11.9951C16.2491 11.0286 17.0326 10.2451 17.9991 10.2451ZM13.7491 11.9951C13.7491 11.0286 12.9656 10.2451 11.9991 10.2451C11.0326 10.2451 10.2491 11.0286 10.2491 11.9951V12.0051C10.2491 12.9716 11.0326 13.7551 11.9991 13.7551C12.9656 13.7551 13.7491 12.9716 13.7491 12.0051V11.9951Z" fill="" />
                </svg>
                </h3>
                ...
                <!-- Menu Item Profiles -->
                <li>
                    <a href="profile.html" class="menu-item group" :class=" (selected === 'Profiles') || (page === 'profiles') ? 'menu-item-active' : 'menu-item-inactive'">
                    <svg :class="(selected === 'Profiles') || (page === 'profiles') ?  'menu-item-icon-active'  :'menu-item-icon-inactive'" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''"> Profiles </span>
                    </a>
                </li>
                <!-- Menu Item Profiles -->
                <!-- Menu Item Users -->
                <li>
                    <a href="users.html" class="menu-item group" :class=" (selected === 'Users') || (page === 'users') ? 'menu-item-active' : 'menu-item-inactive'">
                    <svg :class="(selected === 'Users') || (page === 'users') ?  'menu-item-icon-active'  :'menu-item-icon-inactive'" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
                ...
                <!-- Menu Item Feedbacks -->
                <li>
                    <a href="feedbacks.html" class="menu-item group" :class=" (selected === 'Feedbacks') || (page === 'feedbacks') ? 'menu-item-active' : 'menu-item-inactive'">
                    <svg :class="(selected === 'Feedbacks') || (page === 'feedbacks') ?  'menu-item-icon-active'  :'menu-item-icon-inactive'" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''"> Feedbacks </span>
                    </a>
                </li>
                <!-- Menu Item Feedbacks -->
                </ul>
